import pickle
from tabulate import tabulate  # optional for clean display (pip install tabulate)
import numpy as np
...
class ModelSummary:
    @staticmethod
    # @staticmethod is used when the method operates on external objects (like your model), 
    # not on its own internal state.
    # similar to math.sqrt() — you don’t instantiate a Math class to call it
